...
class Treino(models.Model):
    dia = models.IntegerField()  # De 1(Domingo) a 7 (Sabado)
    ...
    id_exercicio_11 = models.ForeignKey(DescricaoExercicio, on_delete=models.CASCADE, blank=True, null=True, related_name='+')
    id_exercicio_12 = models.ForeignKey(DescricaoExercicio, on_delete=models.CASCADE, blank=True, null=True, related_name='+')

    id_aluno = models.ForeignKey(Aluno, on_delete=models.CASCADE) # Nova implementação
...
class ModoExecucaoExercicio(models.Model):
    dia_do_exercicio = models.IntegerField()  # De 1(Domingo) a 7 (Sabado)
    ...
    id_exercicio = models.ForeignKey(Exercicio, on_delete=models.CASCADE, related_name='exercicios')
    id_aluno = models.ForeignKey(Aluno, on_delete=models.CASCADE)
